...
function DashboardTab() {
    ...
    console.log(product, deleteProduct, edithandle)
                                    ...
                                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400  ">
                                        ...
                                        </thead>
                                        {
                                            product.map((item, index) => {
                                                const { id, imageurl, title, price, category, date, description } = item
                                                console.log(id)
                                                return (
                                                    <tbody className=''>
                                    ...
                                    order.map((allorder, index) => {
                                        return (
                                            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400" >
                                                ...
                                                {
                                                    allorder.cartItem.map((item) => {
                                                        console.log(allorder)
                                                        const { category, descriptio, imageurl, price, title } = item
                                                        return (
                                                            <tbody>
                                                                ...
                                                                <tr className="bg-gray-50 border-b  dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                                                    ...
                                                                    <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                                        {allorder.addressInfo.fullName}
                                                                    </td>
                                                                    <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                                        {allorder.addressInfo.address}
                                                                    </td>
                                                                    <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                                        {allorder.addressInfo.postalCode}
                                                                    </td>
                                                                    <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                                        {allorder.addressInfo.phone}
                                                                    </td>
                                                                    <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                                        {allorder.email}
                                                                    </td>
                                            ...
                                            return (
                                                <tbody>
                                                    ...
                                                    <tr className="bg-gray-50 border-b  dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                                        ...
                                                        <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                           {allUser.email === "ashabaz845@gmail.com" ? "Admin" : `${allUser.email}`}
                                                        </td>
                                                        <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                            {allUser.uid}
                                                        </td>
